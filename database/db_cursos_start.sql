...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-08-2020 a las 22:07:30
...
INSERT INTO `tbl_departamentos` (`id`, `departamento`) VALUES
(5, 'ANTIOQUIA'),
(8, 'ATLÁNTICO'),
(11, 'BOGOTÁ, D.C.'),
(13, 'BOLÍVAR'),
...
--
-- Estructura de tabla para la tabla `tbl_detalle_estudiante_lenguajes`
--

CREATE TABLE `tbl_detalle_estudiante_lenguajes` (
  `id_estudiante` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `tbl_grupo` (`id`, `nombre`, `fecha_inicio`, `fecha_fin`, `descripcion`) VALUES
(7, 'CMD start 1', '2020-08-30 00:00:00', '2020-09-03 00:00:00', 'Pruebas'),
(8, 'CMD start 2', '2020-08-30 00:00:00', '2020-09-04 00:00:00', 'Pruebas');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_historial_estudiantes_grupos`
--

CREATE TABLE `tbl_historial_estudiantes_grupos` (
  `id` int(11) NOT NULL,
  `id_persona` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `tbl_lenguajes` (`id`, `nombre`) VALUES
(1, 'JAVA'),
(2, 'C#'),
(3, 'JAVASCRIPT'),
(4, 'SCALA'),
...
INSERT INTO `tbl_municipios` (`id`, `municipio`, `estado`, `departamento_id`) VALUES
(1, 'Abriaquí', 1, 5),
(2, 'Acacías', 1, 50),
(3, 'Acandí', 1, 27),
(4, 'Acevedo', 1, 41),
...
--
-- Estructura de tabla para la tabla `tbl_tipos_de_documento`
--

CREATE TABLE `tbl_tipos_de_documento` (
  `id` int(11) NOT NULL,
  `nombre` varchar(20) COLLATE utf8_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

--
-- Volcado de datos para la tabla `tbl_tipos_de_documento`
--

INSERT INTO `tbl_tipos_de_documento` (`id`, `nombre`) VALUES
...
--
-- Estructura de tabla para la tabla `tbl_tipo_de_persona`
--

CREATE TABLE `tbl_tipo_de_persona` (
  `id` int(11) NOT NULL,
  `nombre` varchar(50) COLLATE utf8_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

--
-- Volcado de datos para la tabla `tbl_tipo_de_persona`
--

INSERT INTO `tbl_tipo_de_persona` (`id`, `nombre`) VALUES
(1, 'ESTUDIANTE'),
(2, 'PROFESOR');
...
--
-- Indices de la tabla `tbl_detalle_estudiante_lenguajes`
--
ALTER TABLE `tbl_detalle_estudiante_lenguajes`
...
--
-- Indices de la tabla `tbl_historial_estudiantes_grupos`
--
ALTER TABLE `tbl_historial_estudiantes_grupos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_estudiante` (`id_persona`),
...
ALTER TABLE `tbl_persona`
  ...
  ADD KEY `fk_sexo_persona` (`id_sexo`),
  ADD KEY `fk_tipo_de_persona_persona` (`id_tipo_de_persona`),
...
--
-- Indices de la tabla `tbl_tipos_de_documento`
--
ALTER TABLE `tbl_tipos_de_documento`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbl_tipo_de_persona`
--
ALTER TABLE `tbl_tipo_de_persona`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `tbl_historial_estudiantes_grupos`
--
ALTER TABLE `tbl_historial_estudiantes_grupos`
...
--
-- AUTO_INCREMENT de la tabla `tbl_tipos_de_documento`
--
ALTER TABLE `tbl_tipos_de_documento`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `tbl_tipo_de_persona`
--
ALTER TABLE `tbl_tipo_de_persona`
...
--
-- Filtros para la tabla `tbl_detalle_estudiante_lenguajes`
--
ALTER TABLE `tbl_detalle_estudiante_lenguajes`
  ADD CONSTRAINT `fk_estudiante_lenguaje` FOREIGN KEY (`id_estudiante`) REFERENCES `tbl_persona` (`identificacion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_lenguaje_lenguaje` FOREIGN KEY (`id_lenguaje`) REFERENCES `tbl_lenguajes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_historial_estudiantes_grupos`
--
ALTER TABLE `tbl_historial_estudiantes_grupos`
  ADD CONSTRAINT `fk_grupo_grupo` FOREIGN KEY (`id_grupo`) REFERENCES `tbl_grupo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_persona_grupo` FOREIGN KEY (`id_persona`) REFERENCES `tbl_persona` (`identificacion`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_persona`
--
ALTER TABLE `tbl_persona`
  ADD CONSTRAINT `fk_departamento_persona` FOREIGN KEY (`id_departamento`) REFERENCES `tbl_departamentos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_municipio_persona` FOREIGN KEY (`id_municipio`) REFERENCES `tbl_municipios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_sexo_persona` FOREIGN KEY (`id_sexo`) REFERENCES `tbl_sexo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tipo_de_persona_persona` FOREIGN KEY (`id_tipo_de_persona`) REFERENCES `tbl_tipo_de_persona` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tipo_documentacion_persona` FOREIGN KEY (`id_tipo_identificacion`) REFERENCES `tbl_tipos_de_documento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
